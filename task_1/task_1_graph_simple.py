...
A = np.array([[1.12, -0.43, 0.14],
              [-0.07, 1.34, 0.72],
              [1.18, -0.08, -2.25]], dtype='float')
b = np.array([-0.17, 0.62, 1.12])


def task_1_graph_simple(A, b):
    ...
    plt3d.plot_surface(xx, yy, z1, color='orange')
    plt3d.plot_surface(xx, yy, z2, color='red')
    plt3d.plot_surface(xx, yy, z3, color='grey')
    plt.show()
    plt.savefig('task_1_graph_simple', bbox_inches='tight')


task_1_graph_simple(A, b)